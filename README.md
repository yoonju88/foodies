<h1 style="margin-bottom:10px;">Foodies</h1> 
<a href="#">
  <img align="left" alt="Home-Foodies" width="100%" style="padding-right:10px;" src="https://github.com/yoonju88/foodies/blob/main/public/images/home-foodies.png?raw=true" alt="home-foodies"/>
</a> 
...
<ul>
  <li>Installation nextJs : npx create-next-app@latest [folderName]</li> 
  <li>Start projet : npm run dev </li>
  <li>SQLite database :  npm install better-sqlite3 </li>
  <li>Create SQL database to use on the application : node initdb.js </li>
  <li>To prevent cross site scripting attack : npm install slugify xss</li>
</ul>
